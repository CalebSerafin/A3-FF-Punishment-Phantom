...
Examples:
    ["FooBar", "Hello World"] call CSSPunPh_fnc_customHint;
    ["FooBar", "Hello World"] remoteExec ["CSSPunPh_fnc_customHint", 0, false];
    //Save Notify
        ["Restart Notification", "Please make your way to HQ as a restart will occure soon™<br/><br/>Please make sure you save your stats at the Map.", true] remoteExec ["CSSPunPh_fnc_customHint", 0, false];
    ["Vaya...", "Parece que sus notificaciones importantes se cifraron.<br/><br/>Nadie espera el cifrado español.", false, ["functions\UI\images\A3Logo.paa",1]] remoteExec ["CSSPunPh_fnc_customHint", 0, false];
    ...
    // Pre-parse FooBar(Hello World) NoMacro
        ...
        ["FooBar", FooBarParse] call CSSPunPh_fnc_customHint;
