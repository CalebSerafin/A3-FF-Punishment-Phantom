/*
Function:
    CSSPunPh_fnc_punishment_dataSet
...
Examples:
    ...
    private _UID = "123";
    [_UID,_keyPairs] call CSSPunPh_fnc_punishment_dataSet; // In UID "123": Sets values of key "test" to "frost" and "420" to 69
...
if (_keyPairs isEqualTo []) exitWith {
    [1, "INVALID PARAMS | No keys pairs", _filename] remoteExecCall ["CSSPunPh_fnc_log",2,false];
    false;
};
