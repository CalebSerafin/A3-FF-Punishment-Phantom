/*
Function:
    CSSPunPh_fnc_punishment_dataNamespace
...
Examples:
    private _data_namespace = call CSSPunPh_fnc_punishment_dataNamespace; // Gets namespace for getVariable and setVariable
