/*
Function:
    CSSPunPh_fnc_punishment_dataRem
...
Examples:
    ...
    private _UID = "123";
    [_UID,_keys] call CSSPunPh_fnc_punishment_dataRem; // Removes keys "test" and "frost" in UID "123"
    [_UID,[]] call CSSPunPh_fnc_punishment_dataRem;    // Removes UID "123" and all it's keys from _punishment_dataNamespace
